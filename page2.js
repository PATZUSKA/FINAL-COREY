function showText(type) {
    ...
    if (type === "sad") {
        ...
        message = "The reason why I love you? Well actually, there is no reason. There should be no reason. If you love someone because of a reason, when that reason is gone, your heart will change too. I like you without a reason. I like you because you are you.";
    } else if (type === "miss") {
        message = "Have you ever missed someone so much that it feels like a physical ache? Have you ever found yourself staring at your phone, hoping for a message from them, wishing for just a sign that they’re thinking about you too? Has the idea of that one person texting you ever made you forget about everything else, making it hard to focus on anything?";
    } else if (type === "stupid") {
    ...
    textContainer.style.display = "block";  // Rendre le container visible
}